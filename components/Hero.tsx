        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[3rem] items-center">
          <div>
            ...
            <p className="mt-[1.2rem] text-[15px] md:text-[17px] text-[#c4cfde]">
              ...
              quia placeat nemo optio voluptatibus ea nulla architecto
              consequatur recusandae, at fuga animi libero doloribus ab a maxime
              error tempore aperiam?
            </p>
