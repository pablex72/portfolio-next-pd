    ...
    <div className="m-2 hover:bg-gray-700 transition-all duration-300 rounded-lg">
      <div className="border-2 p-4 border-gray-700 rounded-xl">
        ...
        <p className="text-[15px] text-white opacity-65 mt-[3rem] text-center">
          sit amet consectetur adipisicing elit. Neque qui dicta amet, hic eum
          numquam similique ipsum quas et totam, fuga accusamus delectus
          voluptatem ducimus. Incidunt iure voluptates asperiores eaque
          reiciendis recusandae similique mollitia adipisci obcaecati soluta,
          eos aliquid hic?
        </p>
